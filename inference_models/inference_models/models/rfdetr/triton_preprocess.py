...
PRECISION_BITS = 22
_BLOCK_H = int(os.environ.get("RFDETR_TRITON_PREPROC_BLOCK_H", "16"))
_BLOCK_W = int(os.environ.get("RFDETR_TRITON_PREPROC_BLOCK_W", "16"))
_NUM_WARPS = int(os.environ.get("RFDETR_TRITON_PREPROC_NUM_WARPS", "4"))
_NUM_STAGES = int(os.environ.get("RFDETR_TRITON_PREPROC_NUM_STAGES", "2"))
...
def triton_preprocess_rfdetr_stretch(
    ...
    grid = (
        (target_h + _BLOCK_H - 1) // _BLOCK_H,
        (target_w + _BLOCK_W - 1) // _BLOCK_W,
    )
